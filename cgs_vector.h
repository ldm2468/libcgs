...
typedef cgs_vec_type CGS_FUNCTION(type);
 ...
 */
static inline cgs_vec_type CGS_FUNCTION(at)(cgs_vec_name *v, size_t index) {
    assert(index < v->size);
 ...
 */
static inline void CGS_FUNCTION(push_back)(cgs_vec_name *v, cgs_vec_type e) {
 ...
 */
static inline cgs_vec_type CGS_FUNCTION(pop_back)(cgs_vec_name *v) {
    assert(v->size > 0);
 ...
 */
static inline void CGS_FUNCTION(insert)(cgs_vec_name *v, size_t pos, cgs_vec_type e) {
    assert(pos <= v->size);
    CGS_FUNCTION(reserve)(v, v->size + 1);
 ...
 */
static inline cgs_vec_type CGS_FUNCTION(erase)(cgs_vec_name *v, size_t pos) {
    cgs_vec_type res;
    assert(pos < v->size);
    res = v->array[pos];
    v->size--;
 ...
 */
static inline size_t CGS_FUNCTION(find)(cgs_vec_name *v, cgs_vec_type e) {
